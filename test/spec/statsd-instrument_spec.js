...
(function() {
  ...
  User = (function() {
    ...
    User.prototype.friendsList = function(clock) {
      clock.tick(10);
      return true;
    };

    User.prototype.friendsListAsync = function(cb) {
      setTimeout((function() {
        return cb(null, true);
      }), 500);
      return true;
      ...
      'getting list of friends': {
        'synchronously': {
          topic: function() {
            ...
            user = new User();
            return user.friendsList(this.clock);
          },
          teardown: function() {
            return this.clock.restore();
          },
          'should time the fetching to see if caching is needed': function() {
            return assert.isTrue(this.timing_spy.calledWith('friends.fetching', 10));
          }
        },
        'asynchronously': {
          topic: function() {
            ...
            user = new User();
            user.friendsListAsync(this.callback);
            this.clock.tick(500);
            return void 0;
          },
          teardown: function() {
          ...
          'should time the fetching to see if caching is needed': function(err, val) {
            return assert.isTrue(this.timing_spy.calledWith('friends.fetching', 500));
          }
        }
      }
    }
